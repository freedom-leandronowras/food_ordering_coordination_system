...
const menuSectionsData: MenuSectionsData = {
  ...
  dialogs: {
    ...
    grant: {
      ...
      memberTitle: "Request credits",
      memberDescription: "Please talk to your manager to request more credits for your account.",
      memberActionLabel: "Got it",
      amountLabel: "Amount ($)",
  ...
  history: {
    title: "Order History",
    memberDescription: "Your recent orders.",
    managerDescription: "Orders across all members.",
    loadingLabel: "Loading order history...",
    emptyMemberLabel: "No orders found for your account yet.",
    emptyManagerLabel: "No orders found across members yet.",
    memberIdLabel: "Member ID",
    orderIdLabel: "Order ID",
    statusLabel: "Status",
    totalLabel: "Total",
    notesLabel: "Delivery notes",
    noNotesLabel: "No notes",
    itemsLabel: "Items",
  },
  mobileNav: {
